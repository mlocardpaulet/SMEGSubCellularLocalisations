...
```{r, echo=T}
load("Data/Proline/Data01.Rdata")
```
...
save(list = c("matmean", "matDiff", "matpTukey", "vecpval"), file = "Data/Proline/Data02.Rdata")
```

```{r}
load(file = "Data/Proline/Data02.Rdata")
```
...
write.table(export, row.names = F, "Output/Proline/ExportedTableAfterStat.txt", sep = "\t")
save(list = c("export", "mapping", "mattot"), file = "Data/Proline/Data03.Rdata")
```
